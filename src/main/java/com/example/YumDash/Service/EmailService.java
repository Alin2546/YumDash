...
public class EmailService {
    ...
    public void sendPasswordChangedConfirmationEmail(String toEmail) {
        ...
        String htmlMessage = "<html>" +
                ...
                "<br><br>" +
                "<img src='https://i.postimg.cc/4dYCjZJh/Yum-Dash-Logo.jpg' alt='Logo aplicație' width='150'/>" +
                "</body>" +
                "</html>";
        try {
    ...
    public void sendResetPasswordEmail(String toEmail, String resetLink) {
        ...
        String htmlMessage = "<html>" +
                ...
                "<br><img src='https://i.postimg.cc/4dYCjZJh/Yum-Dash-Logo.jpg' alt='Logo aplicație' width='150'/>" +
                "</body>" +
                "</html>";
